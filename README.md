<!-- doc-id: readme; lang: en; revision: 20 -->
...
- Real peer file-transfer qualification, user-selected receive destinations, durable progress/history and peer/outbound ownership across agent restart, the display-layout editor and physical hot-plug qualification, onboarding, exportable diagnostics, and a separately packaged updater supervisor with mutually authenticated IPC, protected journals, platform activation, restart/health/rollback process adapters, Windows UI, and physical power-loss qualification.
