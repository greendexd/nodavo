<!-- doc-id: changelog; lang: en; revision: 15 -->
...
- A bounded, production-inert external update-supervision reducer with distinct install-and-restart consent, exact candidate/predecessor and process-attempt evidence, write-ahead crash recovery, bounded stop/exit/health attempts, and rollback-floor-before-backup-retirement ordering. Legacy in-process activation helpers are test-only; public effect traits remain contracts, with no concrete production activation implementation or entry point wired.
